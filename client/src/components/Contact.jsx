...
function Contact({
  ...
  return (
    ...
    >
      ...
      <button type="submit" className="my-4 col-span-1 lg:col-span-2 flex justify-center items-center border border-transparent text-xl font-bold py-2 text-[#0f1011] bg-gold-500 backdrop-blur-sm rounded-full hover:bg-transparent hover:text-gold-500 hover:border-gold-500 hover:border hover:duration-300">
        Envoyer
      </button>
    </form>
  );
