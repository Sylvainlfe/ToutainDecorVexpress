...
export default function About() {
  return (
    <main className="flex flex-col items-center bg-fixed bg-bg-marbre bg-no-repeat bg-bottom bg-cover h-full bg-black bg-opacity-50 bg-blend-overlay">
      <h2 className="border-l-4 border-gold-500 pl-2 font-bold text-3xl mt-10 text-white lg:self-start lg:ml-4">
        À propos
      </h2>
      <article className="card border-2 border-gold-500 bg-black bg-opacity-50 bg-blend-overlay text-white w-[96%] shadow-xl md:flex md:flex-row md:items-center mt-10 md:w-2/3">
        ...
        <div className="card-body">
          ...
          <p>
            ...
            minima eum voluptas aspernatur nihil? Ipsum rerum voluptatibus
            maiores modi voluptates doloribus dolore vero nam culpa quia sit,
            error animi totam.
          </p>
        </div>
      </article>
      <article className="card border-2 border-gold-500 bg-black bg-opacity-50 bg-blend-overlay text-white w-[96%] shadow-xl md:flex md:flex-row-reverse md:items-center my-10 md:w-2/3">
        ...
        <div className="card-body">
          ...
          <p>
            ...
            unde alias odit repudiandae explicabo laudantium earum assumenda ea
            asperiores, doloremque sequi, voluptatem, sed eius reiciendis.
            Dolorum corporis quisquam at dolore?
          </p>
        </div>
      </article>
    </main>
